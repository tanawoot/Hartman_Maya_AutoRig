...
cmds.joint( 'root', ch=True, e=True, zso=True, oj='yzx', sao='zdown')
cmds.joint( 'L_hip', ch=True, e=True, zso=True, oj='yzx', sao='zdown')
cmds.joint( 'R_hip', ch=True, e=True, zso=True, oj='yzx', sao='zdown')